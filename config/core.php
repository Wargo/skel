 ...
 */
	if (true) {
		...
		Configure::write('Session.save', 'subdomain_session_handler');
	}
 ...
 * Alphanumeric only
 *
 * Default to using the app dir name
 *
 * @link http://es.php.net/manual/en/session.configuration.php#ini.session.name
 */
	Configure::write('Session.cookie', APP_DIR);
 ...
 * @TODO You edit this to make it a fixed unique value
 */
	Configure::write('Security.salt', sha1(__FILE__));

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 * @TODO You edit this to make it a fixed unique value
 */
	Configure::write('Security.cipherSeed', filemtime(__FILE__));
